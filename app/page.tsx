        ...
        <div className="container mx-auto px-4 z-10 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex gap-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
              ...
              <a href="https://damp-flower-426.linkyhost.com/" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-black text-white border-2 border-cyan-500 rounded-full font-semibold hover:bg-gradient-to-r hover:from-cyan-500 hover:to-blue-500 transition-all duration-200">
                Resume
              </a>
            </div>
      ...
      <section id="contact" className="py-24 px-4 bg-black border-t border-white/5">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <a href="https://damp-flower-426.linkyhost.com/" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-black text-white border-2 border-cyan-500 rounded-full font-semibold hover:bg-gradient-to-r hover:from-cyan-500 hover:to-blue-500 transition-all duration-200 flex items-center justify-center gap-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
